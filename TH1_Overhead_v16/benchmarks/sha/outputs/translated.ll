...
@.str.4 = private unnamed_addr constant [36 x i8] c"./evaluations/overhead/time_overead\00", align 1
...
; <label>:22:                                     ; preds = %20
  ...
  %23 = call i32 @gettimeofday(%struct.timeval* %8, %struct.timezone* null) #4
  br label %24
...
; <label>:24:                                     ; preds = %22
  ...
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.3, i32 0, i32 0), i64 %36)
  br label %38

; <label>:38:                                     ; preds = %24
  call void @enqueue_signature(i32 720905)
  store i32 1, i32* @is_signature_queue_full, align 4
  %39 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  br label %40
...
; <label>:58:                                     ; preds = %55
  call void @enqueue_signature_with_remainder_process(i32 720908)
  ret i32 0
}

...
@.str.3 = private unnamed_addr constant [36 x i8] c"./evaluations/overhead/time_overead\00", align 1
...
define i32 @main(i32, i8**) #0 {
  ...
  %12 = call i32 @gettimeofday(%struct.timeval* %9, %struct.timezone* null) #3
  br label %13
...
; <label>:17:                                     ; preds = %13
  ...
  %21 = call i32 @crc32file(i8* %20, i64* %6, i64* %7)
  br label %22
...
; <label>:25:                                     ; preds = %13
  ...
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i32 0, i32 0))
  br label %27
...
; <label>:29:                                     ; preds = %27
  ...
  %30 = getelementptr inbounds %struct.timeval, %struct.timeval* %10, i32 0, i32 0
  %31 = load i64, i64* %30, align 8
  %32 = getelementptr inbounds %struct.timeval, %struct.timeval* %9, i32 0, i32 0
  %33 = load i64, i64* %32, align 8
  %34 = sub nsw i64 %31, %33
  %35 = mul nsw i64 %34, 1000000
  %36 = getelementptr inbounds %struct.timeval, %struct.timeval* %10, i32 0, i32 1
  %37 = load i64, i64* %36, align 8
  %38 = getelementptr inbounds %struct.timeval, %struct.timeval* %9, i32 0, i32 1
  %39 = load i64, i64* %38, align 8
  %40 = sub nsw i64 %37, %39
  %41 = add nsw i64 %35, %40
  %42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0), i64 %41)
  br label %43

; <label>:43:                                     ; preds = %29
  call void @enqueue_signature(i32 589832)
  store i32 1, i32* @is_signature_queue_full, align 4
  %44 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
  br label %45

; <label>:45:                                     ; preds = %43
  call void @enqueue_signature(i32 589833)
  store %struct._IO_FILE* %44, %struct._IO_FILE** %11, align 8
  ...
  %59 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %46, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i32 0, i32 0), i64 %58)
  br label %60

; <label>:60:                                     ; preds = %45
  call void @enqueue_signature(i32 589834)
  %61 = load %struct._IO_FILE*, %struct._IO_FILE** %11, align 8
  %62 = call i32 @fclose(%struct._IO_FILE* %61)
  br label %63

; <label>:63:                                     ; preds = %60
  call void @enqueue_signature_with_remainder_process(i32 589835)

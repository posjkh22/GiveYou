...
void initialize_monitor_routine(unsigned int node_id)
{
	...
	add_basicblock(p_integrated_CFG, 0x9003a, 1, 0x1, 0x9003b);
	add_basicblock(p_integrated_CFG, 0x9003b, 1, 0x1, 0x9003c);
	add_basicblock(p_integrated_CFG, 0x9003c, 1, 0x1, 0x9003d);
	add_basicblock(p_integrated_CFG, 0x9003d, 4, 0x2, 0x0);
	add_basicblock(p_integrated_CFG, 0x9003d, 4, 0x2, 0x0);

...
@.str.9 = private unnamed_addr constant [36 x i8] c"./evaluations/overhead/time_overead\00", align 1
...
define i32 @main(i32, i8**) #0 {
  ...
  %19 = call i32 @gettimeofday(%struct.timeval* %16, %struct.timezone* null) #6
  br label %20
...
; <label>:24:                                     ; preds = %22
  ...
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0), i8* %27)
  br label %29
...
; <label>:33:                                     ; preds = %31
  ...
  %34 = bitcast i8* %32 to %struct.ptree*
  store %struct.ptree* %34, %struct.ptree** %6, align 8
  %35 = load %struct.ptree*, %struct.ptree** %6, align 8
  %36 = icmp ne %struct.ptree* %35, null
...
; <label>:40:                                     ; preds = %33
  ...
  call void @llvm.memset.p0i8.i64(i8* %42, i8 0, i64 40, i32 8, i1 false)
  br label %43
...
; <label>:56:                                     ; preds = %45
  ...
  %60 = bitcast %struct.ptree_mask* %59 to i8*
  call void @llvm.memset.p0i8.i64(i8* %60, i8 0, i64 16, i32 8, i1 false)
  br label %61

; <label>:61:                                     ; preds = %56
  call void @enqueue_signature(i32 589843)
  %62 = load %struct.ptree*, %struct.ptree** %6, align 8
  %63 = getelementptr inbounds %struct.ptree, %struct.ptree* %62, i32 0, i32 1
  %64 = load %struct.ptree_mask*, %struct.ptree_mask** %63, align 8
  store %struct.ptree_mask* %64, %struct.ptree_mask** %9, align 8
  %65 = call noalias i8* @malloc(i64 16) #6
  br label %66

; <label>:66:                                     ; preds = %61
  call void @enqueue_signature(i32 589844)
  %67 = bitcast i8* %65 to %struct.MyNode*
  %68 = bitcast %struct.MyNode* %67 to i8*
  %69 = load %struct.ptree_mask*, %struct.ptree_mask** %9, align 8
  %70 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %69, i32 0, i32 1
...
; <label>:78:                                     ; preds = %66
  ...
  %79 = load %struct.ptree_mask*, %struct.ptree_mask** %9, align 8
  %80 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %79, i32 0, i32 1
  %81 = load i8*, i8** %80, align 8
  call void @llvm.memset.p0i8.i64(i8* %81, i8 0, i64 1, i32 1, i1 false)
  br label %82

; <label>:82:                                     ; preds = %78
  call void @enqueue_signature(i32 589849)
  %83 = load %struct.ptree*, %struct.ptree** %6, align 8
  %84 = getelementptr inbounds %struct.ptree, %struct.ptree* %83, i32 0, i32 2
  store i8 1, i8* %84, align 8
  %85 = load %struct.ptree*, %struct.ptree** %6, align 8
  %86 = load %struct.ptree*, %struct.ptree** %6, align 8
  %87 = getelementptr inbounds %struct.ptree, %struct.ptree* %86, i32 0, i32 5
  store %struct.ptree* %85, %struct.ptree** %87, align 8
  %88 = load %struct.ptree*, %struct.ptree** %6, align 8
  %89 = getelementptr inbounds %struct.ptree, %struct.ptree* %88, i32 0, i32 4
  store %struct.ptree* %85, %struct.ptree** %89, align 8
  br label %90

; <label>:90:                                     ; preds = %185, %82
  call void @enqueue_signature(i32 589850)
  %91 = getelementptr inbounds [128 x i8], [128 x i8]* %11, i32 0, i32 0
  %92 = load %struct._IO_FILE*, %struct._IO_FILE** %10, align 8
  %93 = call i8* @fgets(i8* %91, i32 128, %struct._IO_FILE* %92)
  br label %94

; <label>:94:                                     ; preds = %90
  call void @enqueue_signature(i32 589851)
  %95 = icmp ne i8* %93, null
  br i1 %95, label %96, label %186

; <label>:96:                                     ; preds = %94
  call void @enqueue_signature(i32 589852)
  %97 = getelementptr inbounds [128 x i8], [128 x i8]* %11, i32 0, i32 0
  %98 = bitcast %struct.in_addr* %13 to i32*
  %99 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %97, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6, i32 0, i32 0), float* %15, i32* %98) #6
  br label %100
...
; <label>:102:                                    ; preds = %100
  ...
  %103 = bitcast i8* %101 to %struct.ptree*
  store %struct.ptree* %103, %struct.ptree** %7, align 8
  %104 = load %struct.ptree*, %struct.ptree** %7, align 8
  %105 = icmp ne %struct.ptree* %104, null
...
; <label>:109:                                    ; preds = %102
  ...
  %110 = load %struct.ptree*, %struct.ptree** %7, align 8
  %111 = bitcast %struct.ptree* %110 to i8*
  call void @llvm.memset.p0i8.i64(i8* %111, i8 0, i64 40, i32 8, i1 false)
  br label %112
...
; <label>:114:                                    ; preds = %112
  ...
  %115 = bitcast i8* %113 to %struct.ptree_mask*
  %116 = load %struct.ptree*, %struct.ptree** %7, align 8
  %117 = getelementptr inbounds %struct.ptree, %struct.ptree* %116, i32 0, i32 1
  store %struct.ptree_mask* %115, %struct.ptree_mask** %117, align 8
  %118 = load %struct.ptree*, %struct.ptree** %7, align 8
  %119 = getelementptr inbounds %struct.ptree, %struct.ptree* %118, i32 0, i32 1
  %120 = load %struct.ptree_mask*, %struct.ptree_mask** %119, align 8
  %121 = icmp ne %struct.ptree_mask* %120, null
...
; <label>:125:                                    ; preds = %114
  ...
  %126 = load %struct.ptree*, %struct.ptree** %7, align 8
  %127 = getelementptr inbounds %struct.ptree, %struct.ptree* %126, i32 0, i32 1
  %128 = load %struct.ptree_mask*, %struct.ptree_mask** %127, align 8
  %129 = bitcast %struct.ptree_mask* %128 to i8*
  call void @llvm.memset.p0i8.i64(i8* %129, i8 0, i64 16, i32 8, i1 false)
  br label %130

; <label>:130:                                    ; preds = %125
  call void @enqueue_signature(i32 589865)
  %131 = load %struct.ptree*, %struct.ptree** %7, align 8
  %132 = getelementptr inbounds %struct.ptree, %struct.ptree* %131, i32 0, i32 1
  %133 = load %struct.ptree_mask*, %struct.ptree_mask** %132, align 8
  store %struct.ptree_mask* %133, %struct.ptree_mask** %9, align 8
  %134 = call noalias i8* @malloc(i64 16) #6
  br label %135

; <label>:135:                                    ; preds = %130
  call void @enqueue_signature(i32 589866)
  %136 = bitcast i8* %134 to %struct.MyNode*
  %137 = bitcast %struct.MyNode* %136 to i8*
  %138 = load %struct.ptree_mask*, %struct.ptree_mask** %9, align 8
  %139 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %138, i32 0, i32 1
  store i8* %137, i8** %139, align 8
  %140 = load %struct.ptree_mask*, %struct.ptree_mask** %9, align 8
  %141 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %140, i32 0, i32 1
...
; <label>:147:                                    ; preds = %135
  ...
  %148 = load %struct.ptree_mask*, %struct.ptree_mask** %9, align 8
  %149 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %148, i32 0, i32 1
  %150 = load i8*, i8** %149, align 8
  call void @llvm.memset.p0i8.i64(i8* %150, i8 0, i64 1, i32 1, i1 false)
  br label %151
...
; <label>:151:                                    ; preds = %147
  ...
  %155 = load %struct.ptree*, %struct.ptree** %7, align 8
  %156 = getelementptr inbounds %struct.ptree, %struct.ptree* %155, i32 0, i32 0
...
; <label>:160:                                    ; preds = %151
  ...
  %163 = getelementptr inbounds %struct.ptree, %struct.ptree* %162, i32 0, i32 1
  %164 = load %struct.ptree_mask*, %struct.ptree_mask** %163, align 8
  %165 = getelementptr inbounds %struct.ptree_mask, %struct.ptree_mask* %164, i32 0, i32 0
  store i64 %161, i64* %165, align 8
  %166 = getelementptr inbounds %struct.in_addr, %struct.in_addr* %13, i32 0, i32 0
  %167 = load i32, i32* %166, align 4
  %168 = zext i32 %167 to i64
  %169 = load %struct.ptree*, %struct.ptree** %6, align 8
  %170 = call %struct.ptree* @pat_search(i64 %168, %struct.ptree* %169)
  br label %171

; <label>:171:                                    ; preds = %160
  call void @enqueue_signature(i32 589873)
  store %struct.ptree* %170, %struct.ptree** %8, align 8
  %172 = load %struct.ptree*, %struct.ptree** %8, align 8
  %173 = getelementptr inbounds %struct.ptree, %struct.ptree* %172, i32 0, i32 0
  %174 = load i64, i64* %173, align 8
  %175 = getelementptr inbounds %struct.in_addr, %struct.in_addr* %13, i32 0, i32 0
...
; <label>:181:                                    ; preds = %180, %179
  ...
  %182 = load %struct.ptree*, %struct.ptree** %7, align 8
  %183 = icmp ne %struct.ptree* %182, null
...
; <label>:186:                                    ; preds = %94
  ...
  %187 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.7, i32 0, i32 0))
  br label %188

; <label>:188:                                    ; preds = %186
  call void @enqueue_signature(i32 589880)
  %189 = call i32 @gettimeofday(%struct.timeval* %17, %struct.timezone* null) #6
  br label %190

; <label>:190:                                    ; preds = %188
  call void @enqueue_signature(i32 589881)
  %191 = getelementptr inbounds %struct.timeval, %struct.timeval* %17, i32 0, i32 0
  %192 = load i64, i64* %191, align 8
  %193 = getelementptr inbounds %struct.timeval, %struct.timeval* %16, i32 0, i32 0
  %194 = load i64, i64* %193, align 8
  %195 = sub nsw i64 %192, %194
  %196 = mul nsw i64 %195, 1000000
  %197 = getelementptr inbounds %struct.timeval, %struct.timeval* %17, i32 0, i32 1
  %198 = load i64, i64* %197, align 8
  %199 = getelementptr inbounds %struct.timeval, %struct.timeval* %16, i32 0, i32 1
  %200 = load i64, i64* %199, align 8
  %201 = sub nsw i64 %198, %200
  %202 = add nsw i64 %196, %201
  %203 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.8, i32 0, i32 0), i64 %202)
  br label %204

; <label>:204:                                    ; preds = %190
  call void @enqueue_signature(i32 589882)
  store i32 1, i32* @is_signature_queue_full, align 4
  %205 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i32 0, i32 0))
  br label %206

; <label>:206:                                    ; preds = %204
  call void @enqueue_signature(i32 589883)
  store %struct._IO_FILE* %205, %struct._IO_FILE** %18, align 8
  %207 = load %struct._IO_FILE*, %struct._IO_FILE** %18, align 8
  %208 = getelementptr inbounds %struct.timeval, %struct.timeval* %17, i32 0, i32 0
  %209 = load i64, i64* %208, align 8
  %210 = getelementptr inbounds %struct.timeval, %struct.timeval* %16, i32 0, i32 0
  %211 = load i64, i64* %210, align 8
  %212 = sub nsw i64 %209, %211
  %213 = mul nsw i64 %212, 1000000
  %214 = getelementptr inbounds %struct.timeval, %struct.timeval* %17, i32 0, i32 1
  %215 = load i64, i64* %214, align 8
  %216 = getelementptr inbounds %struct.timeval, %struct.timeval* %16, i32 0, i32 1
  %217 = load i64, i64* %216, align 8
  %218 = sub nsw i64 %215, %217
  %219 = add nsw i64 %213, %218
  %220 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %207, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.11, i32 0, i32 0), i64 %219)
  br label %221

; <label>:221:                                    ; preds = %206
  call void @enqueue_signature(i32 589884)
  %222 = load %struct._IO_FILE*, %struct._IO_FILE** %18, align 8
  %223 = call i32 @fclose(%struct._IO_FILE* %222)
  br label %224

; <label>:224:                                    ; preds = %221
  call void @enqueue_signature_with_remainder_process(i32 589885)

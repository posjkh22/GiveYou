...
; <label>:145:                                    ; preds = %128, %127
  ...
  %147 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i32 0, i32 0))
  %148 = getelementptr inbounds %struct.timeval, %struct.timeval* %13, i32 0, i32 0
  %149 = load i64, i64* %148, align 8
  %150 = getelementptr inbounds %struct.timeval, %struct.timeval* %11, i32 0, i32 0
  %151 = load i64, i64* %150, align 8
  %152 = sub nsw i64 %149, %151
  %153 = mul nsw i64 %152, 1000000
  %154 = getelementptr inbounds %struct.timeval, %struct.timeval* %13, i32 0, i32 1
  ...
  %160 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5, i32 0, i32 0), i64 %159)
  %161 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
  store %struct._IO_FILE* %161, %struct._IO_FILE** %14, align 8
  ...
  %175 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %162, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i32 0, i32 0), i64 %174)

...
; <label>:344:                                    ; preds = %338
  %345 = call i32 @gettimeofday(%struct.timeval* %29, %struct.timezone* null) #3
  %346 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i32 0, i32 0))
  %347 = getelementptr inbounds %struct.timeval, %struct.timeval* %29, i32 0, i32 0
  %348 = load i64, i64* %347, align 8
  %349 = getelementptr inbounds %struct.timeval, %struct.timeval* %28, i32 0, i32 0
  %350 = load i64, i64* %349, align 8
  %351 = sub nsw i64 %348, %350
  %352 = mul nsw i64 %351, 1000000
  %353 = getelementptr inbounds %struct.timeval, %struct.timeval* %29, i32 0, i32 1
  %354 = load i64, i64* %353, align 8
  %355 = getelementptr inbounds %struct.timeval, %struct.timeval* %28, i32 0, i32 1
  %356 = load i64, i64* %355, align 8
  %357 = sub nsw i64 %354, %356
  %358 = add nsw i64 %352, %357
  %359 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i64 %358)
  %360 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  store %struct._IO_FILE* %360, %struct._IO_FILE** %30, align 8
  %361 = load %struct._IO_FILE*, %struct._IO_FILE** %30, align 8
  ...
  %374 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %361, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i64 %373)
  %375 = load %struct._IO_FILE*, %struct._IO_FILE** %30, align 8
  %376 = call i32 @fclose(%struct._IO_FILE* %375)
  ret i32 0
}

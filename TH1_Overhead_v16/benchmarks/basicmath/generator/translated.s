...
.Lcfi3:
	...
	movsd	%xmm1, -32(%rbp)
	movsd	%xmm0, -24(%rbp)
	movq	$1072497001, -64(%rbp)  # imm = 0x3FED0169
	movq	$0, -168(%rbp)
	xorl	%esi, %esi
	callq	gettimeofday
# BB#1:
...
.LBB0_62:                               # =>This Inner Loop Header: Depth=1
	...
	callq	enqueue_signature
	cmpq	$1072513385, -64(%rbp)  # imm = 0x3FED4169
	jae	.LBB0_65
...
# BB#72:                                #   in Loop: Header=BB0_71 Depth=1
	...
	mulsd	-144(%rbp), %xmm2       # 8-byte Folded Reload
	mulsd	%xmm1, %xmm2
	addsd	%xmm0, %xmm2
	ucomisd	-72(%rbp), %xmm2        # 8-byte Folded Reload
	jb	.LBB0_77
...
# BB#81:
	...
	callq	fprintf
# BB#82:
	movl	$65619, %edi            # imm = 0x10053
	callq	enqueue_signature
	movq	-104(%rbp), %rdi
	callq	fclose
# BB#83:
	movl	$65620, %edi            # imm = 0x10054

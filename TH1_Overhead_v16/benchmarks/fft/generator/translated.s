...
# BB#6:
	...
	callq	enqueue_signature_with_call
	movabsq	$.L.str.2.10, %rsi
	movq	-88(%rbp), %rdi
	callq	CheckPointer
# BB#7:
	movl	$1114120, %edi          # imm = 0x110008
	callq	enqueue_signature_with_call
	movabsq	$.L.str.3.11, %rsi
	movq	-80(%rbp), %rdi
	callq	CheckPointer
# BB#8:
...
.LBB5_24:                               #   Parent Loop BB5_18 Depth=1
                                        ...
                                        #       Child Loop BB5_26 Depth 3
	movl	$1114137, %edi          # imm = 0x110019
	callq	enqueue_signature
	movl	-44(%rbp), %eax
	cmpl	-52(%rbp), %eax
	jae	.LBB5_31
# BB#25:                                #   in Loop: Header=BB5_24 Depth=2
	movl	$1114138, %edi          # imm = 0x11001A
	callq	enqueue_signature
...
.LBB5_26:                               #   Parent Loop BB5_18 Depth=1
	...
	movl	$1114139, %edi          # imm = 0x11001B
	callq	enqueue_signature
	movl	-96(%rbp), %eax
	cmpl	-92(%rbp), %eax
	jae	.LBB5_29
# BB#27:                                #   in Loop: Header=BB5_26 Depth=3
	movl	$1114140, %edi          # imm = 0x11001C
	callq	enqueue_signature
...
.LBB5_29:                               #   in Loop: Header=BB5_24 Depth=2
	movl	$1114142, %edi          # imm = 0x11001E
	callq	enqueue_signature
# BB#30:                                #   in Loop: Header=BB5_24 Depth=2
	movl	$1114143, %edi          # imm = 0x11001F
	callq	enqueue_signature
	movl	-68(%rbp), %eax
	addl	-44(%rbp), %eax
	movl	%eax, -44(%rbp)
...
.LBB5_31:                               #   in Loop: Header=BB5_18 Depth=1
	movl	$1114144, %edi          # imm = 0x110020
	callq	enqueue_signature
	movl	-68(%rbp), %eax
	movl	%eax, -92(%rbp)
# BB#32:                                #   in Loop: Header=BB5_18 Depth=1
	movl	$1114145, %edi          # imm = 0x110021
	callq	enqueue_signature
	movl	-68(%rbp), %eax
	shll	$1, %eax
	movl	%eax, -68(%rbp)
	jmp	.LBB5_18
.LBB5_33:
	movl	$1114146, %edi          # imm = 0x110022
	callq	enqueue_signature
	cmpl	$0, -100(%rbp)
	je	.LBB5_39
# BB#34:
	movl	$1114147, %edi          # imm = 0x110023
	callq	enqueue_signature
	movl	-52(%rbp), %eax
	cvtsi2sdq	%rax, %xmm0
	movsd	%xmm0, -200(%rbp)
...
.LBB5_35:                               # =>This Inner Loop Header: Depth=1
	movl	$1114148, %edi          # imm = 0x110024
	callq	enqueue_signature
	movl	-44(%rbp), %eax
	cmpl	-52(%rbp), %eax
	jae	.LBB5_38
# BB#36:                                #   in Loop: Header=BB5_35 Depth=1
	movl	$1114149, %edi          # imm = 0x110025
	callq	enqueue_signature
...
# BB#37:                                #   in Loop: Header=BB5_35 Depth=1
	...
	jmp	.LBB5_35
.LBB5_38:
	movl	$1114151, %edi          # imm = 0x110027
	callq	enqueue_signature
.LBB5_39:
	movl	$1114152, %edi          # imm = 0x110028
	callq	enqueue_signature_with_return
	addq	$248, %rsp
	popq	%rbx
	popq	%r12

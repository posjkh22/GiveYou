...
; <label>:151:                                    ; preds = %70
  ...
  %171 = call i32 @gettimeofday(%struct.timeval* %14, %struct.timezone* null) #3
  %172 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0))
  %173 = getelementptr inbounds %struct.timeval, %struct.timeval* %14, i32 0, i32 0
  %174 = load i64, i64* %173, align 8
  %175 = getelementptr inbounds %struct.timeval, %struct.timeval* %13, i32 0, i32 0
  %176 = load i64, i64* %175, align 8
  %177 = sub nsw i64 %174, %176
  %178 = mul nsw i64 %177, 1000000
  %179 = getelementptr inbounds %struct.timeval, %struct.timeval* %14, i32 0, i32 1
  ...
  %185 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i32 0, i32 0), i64 %184)
  %186 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  store %struct._IO_FILE* %186, %struct._IO_FILE** %15, align 8
  %187 = load %struct._IO_FILE*, %struct._IO_FILE** %15, align 8
  %188 = getelementptr inbounds %struct.timeval, %struct.timeval* %14, i32 0, i32 0
  ...
  %194 = getelementptr inbounds %struct.timeval, %struct.timeval* %14, i32 0, i32 1
  ...
  %201 = load %struct._IO_FILE*, %struct._IO_FILE** %15, align 8

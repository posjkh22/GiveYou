...
void initialize_monitor_routine(unsigned int node_id)
{
	...
	add_basicblock(p_integrated_CFG, 0x11000d, 1, 0x1, 0x11000e);
	add_basicblock(p_integrated_CFG, 0x11000e, 1, 0x1, 0x11000f);
	add_basicblock(p_integrated_CFG, 0x11000f, 1, 0x1, 0x110010);
	add_basicblock(p_integrated_CFG, 0x110010, 4, 0x2, 0x0);
	add_basicblock(p_integrated_CFG, 0x110010, 4, 0x2, 0x0);

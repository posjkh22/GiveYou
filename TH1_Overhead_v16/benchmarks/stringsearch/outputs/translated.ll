...
@.str.213 = private unnamed_addr constant [36 x i8] c"./evaluations/overhead/time_overead\00", align 1
@.str.214 = private unnamed_addr constant [2 x i8] c"a\00", align 1
@.str.215 = private unnamed_addr constant [5 x i8] c"%ld\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %9 = bitcast [1333 x i8*]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %9, i8* bitcast ([1333 x i8*]* @main.find_strings to i8*), i64 10664, i32 16, i1 false)
  br label %10

; <label>:10:                                     ; preds = %0
  call void @enqueue_signature(i32 1114114)
  %11 = bitcast [1332 x i8*]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %11, i8* bitcast ([1332 x i8*]* @main.search_strings to i8*), i64 10656, i32 16, i1 false)
  br label %12

; <label>:12:                                     ; preds = %10
  call void @enqueue_signature(i32 1114115)
  %13 = call i32 @gettimeofday(%struct.timeval* %5, %struct.timezone* null) #6
  br label %14
...
; <label>:15:                                     ; preds = %33, %14
  ...
  %18 = getelementptr inbounds [1333 x i8*], [1333 x i8*]* %3, i64 0, i64 %17
...
; <label>:21:                                     ; preds = %15
  ...
  %24 = getelementptr inbounds [1333 x i8*], [1333 x i8*]* %3, i64 0, i64 %23
  %25 = load i8*, i8** %24, align 8
  call void @init_search(i8* %25)
  br label %26
...
; <label>:26:                                     ; preds = %21
  ...
  %29 = getelementptr inbounds [1332 x i8*], [1332 x i8*]* %4, i64 0, i64 %28
  %30 = load i8*, i8** %29, align 8
  %31 = call i8* @strsearch(i8* %30)
  br label %32
...
; <label>:36:                                     ; preds = %15
  ...
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.211, i32 0, i32 0))
  br label %38

; <label>:38:                                     ; preds = %36
  call void @enqueue_signature(i32 1114123)
  %39 = call i32 @gettimeofday(%struct.timeval* %6, %struct.timezone* null) #6
  br label %40
...
; <label>:40:                                     ; preds = %38
  ...
  %49 = getelementptr inbounds %struct.timeval, %struct.timeval* %5, i32 0, i32 1
  %50 = load i64, i64* %49, align 8
  %51 = sub nsw i64 %48, %50
  %52 = add nsw i64 %46, %51
  %53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.212, i32 0, i32 0), i64 %52)
  br label %54

; <label>:54:                                     ; preds = %40
  call void @enqueue_signature(i32 1114125)
  store i32 1, i32* @is_signature_queue_full, align 4
  %55 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.213, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.214, i32 0, i32 0))
  br label %56
...
; <label>:56:                                     ; preds = %54
  ...
  %60 = getelementptr inbounds %struct.timeval, %struct.timeval* %5, i32 0, i32 0
  %61 = load i64, i64* %60, align 8
  %62 = sub nsw i64 %59, %61
  %63 = mul nsw i64 %62, 1000000
  %64 = getelementptr inbounds %struct.timeval, %struct.timeval* %6, i32 0, i32 1
  %65 = load i64, i64* %64, align 8
  %66 = getelementptr inbounds %struct.timeval, %struct.timeval* %5, i32 0, i32 1
  %67 = load i64, i64* %66, align 8
  %68 = sub nsw i64 %65, %67
  %69 = add nsw i64 %63, %68
  %70 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %57, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.215, i32 0, i32 0), i64 %69)
  br label %71
...
; <label>:74:                                     ; preds = %71
  call void @enqueue_signature_with_remainder_process(i32 1114128)
  ret i32 0
}
